    ...
    return (
        <View style={globalStyles.calculatorContainer}>
            ...
            <View style={globalStyles.row}>
                <CalculatorButton label='C' blackText color={Colors.lightGrey} onPress={()=>console.log("C")}/>
                <CalculatorButton label='+/-' blackText color={Colors.lightGrey} onPress={()=>console.log("+/-")}/>
                <CalculatorButton label='del' blackText color={Colors.lightGrey} onPress={()=>console.log("del")}/>
